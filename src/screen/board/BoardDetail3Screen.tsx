...
const COPY = {
  ...
  author: '오지훈',
  body: `웹프 3장 과제 조건 중에 
    첫번째페이지– 최소2개이상의상호작용유형적용 
    두번째페이지– form 데이터입력과정의상호작용과제출후상호작용포함최소3개이상 \n\n
    여기서 첫번재는 발생 대상을 늘리는 거고 두번째는 상호 작용 자체의 종류를 늘리는 거라고 수정하셨습니다. 
    두번째 회원가입 폼에서는 submit 버튼을 누르면 reload 되지 않고 '제출 완료' 라는 문구가 뜨거나
    입력한 데이터를 한번에 보여주는 부분을 새로 만드는 것도 말씀하셨습니다. 
    참고하면 될것같습니다. \n\n
    과제 조건을 바꾸셨는데 lms가 오류나서 학우분들께 말씀드려달라고 하셨습니다!! ...\n\n`,
  attachHeader: '첨부 파일',
